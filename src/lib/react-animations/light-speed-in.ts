...
const translateAndSkew = compose(translate3d, skewX);
...
const lightSpeedIn: Animation = {
  ...
  "60%": { ...easeIn, opacity: 1, transform: skewX(20) },
  "80%": { ...easeIn, opacity: 1, transform: skewX(-5) },
  to: { ...easeIn, transform: "none", opacity: 1 },
};
