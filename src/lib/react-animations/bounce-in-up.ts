...
const bounceInUp: Animation = {
  ...
  "60%": { ...timing, opacity: 1, transform: translate3d(0, "-20px", 0) },
  "75%": { ...timing, transform: translate3d(0, "10px", 0) },
  "90%": { ...timing, transform: translate3d(0, "-5px", 0) },
  to: { ...timing, transform: "none" },
};
